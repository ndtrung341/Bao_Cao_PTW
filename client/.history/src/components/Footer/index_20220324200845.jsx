...
const useStyles = makeStyles((theme) => ({
   root: {
      ...
      backgroundImage: ` linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url("https://images.unsplash.com/photo-1595348020949-87cdfbb44174?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8d2hleXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=700&q=100")`,
               ...
               <Grid item lg={3} md={3} xs={2}>
                  <Box mt={4}>
                     ...
                     <Box sx={{ display: 'flex' }} component='form'>
                        <OutlinedInput placeholder='Nhập địa chỉ email' className={classes.input} size='small' />
